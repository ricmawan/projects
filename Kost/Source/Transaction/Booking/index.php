			...
			$(document).ready(function() {
				var grid = $("#grid-data").bootgrid({
							...
							formatters: {
								...
								{
									return "<i style='cursor:pointer;' data-row-id=\"" + row.BookingID + "\" class=\"fa fa-edit\" data-link=\"./Transaction/Booking/Detail.php?ID=" + row.RoomID + "&BookingID=" + row.BookingID +"\" acronym title=\"Ubah Data\"></i>&nbsp;";
								}
							}
