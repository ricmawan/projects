		...
		<script>
			$(document).ready(function() {
				var grid = $("#grid-data").bootgrid({
							...
							url: "./Transaction/ProjectPayment/DataSource.php",
							selection: false,
							multiSelect: false,
							rowSelect: true,
							keepSelection: true,
							formatters: {
								...
								{
									return "<i style='cursor:pointer;' data-row-id=\"" + row.ProjectID + "\" class=\"fa fa-list-alt\" data-link=\"./Transaction/ProjectPayment/Detail.php?ID=" + row.ProjectID + "\" acronym title=\"Detail Pembayaran Proyek\"></i>&nbsp;";
								}
							}
