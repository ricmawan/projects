				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
							...
							<div class="row">
								...
								<div class="col-md-5">
									...
									<div class="ui-widget" style="width: 100%;">
										<select name="ddlSupplier" id="ddlSupplier" class="form-control" placeholder="Pilih Pelanggan" >
						...
						<div class="row">
							...
							<div class="col-md-2">
								<input type="text" id="txtDeliveryCost" style="text-align:right;" value="0.00" name="txtDeliveryCost" class="form-control" onchange="Calculate();" onkeypress="return isNumberKey(event, this.id, this.value)" onfocus="clearFormat(this.id, this.value)" onblur="convertRupiah(this.id, this.value)" />
							</div>
						</div>
						<br />
						<div class="row">
