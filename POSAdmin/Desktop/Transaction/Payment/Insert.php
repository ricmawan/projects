<?php
	if(isset($_POST['hdnPaymentDetailsID'])) {
		...
		$FailedFlag = 0;
		$State = 1;
		$sql = "CALL spInsPayment(".$TransactionID.", '".$PaymentDate."', '".$TransactionType."', ".$PaymentDetailsID.", ".$Amount.", '".$Remarks."', '".$_SESSION['UserLoginKasir']."')";
		if (! $result=mysqli_query($dbh, $sql)) {
			$MessageDetail = mysqli_error($dbh);
			$FailedFlag = 1;
			logEvent(mysqli_error($dbh), '/Transaction/Payment/Insert.php', mysqli_real_escape_string($dbh, $_SESSION['UserLoginKasir']));
