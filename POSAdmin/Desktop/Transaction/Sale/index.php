	...
	<body>
		...
		<div id="FormData" title="Tambah Penjualan" class="col-md-12" >
			<form class="col-md-12" id="PostForm" method="POST" action="" >
				...
				<br />
				<div class="row" >
					<h5 style="margin: 5px 0 0 0;">F1= Batalkan Transaksi;F2= Hapus Barang Terakhir;F8= Cetak Nota Terakhir;F10= Transaksi Selesai;F11= Daftar Pelanggan;F12= Daftar Barang;ESC= Tutup;DELETE= Hapus;ENTER/DOUBLE KLIK= Edit;</h5>
				</div>
			</form>
		</div>
				...
				$( window ).resize(function() {
					waitForFinalEvent(function () {
		               	setTimeout(function() {
							...
							if ( $.fn.DataTable.isDataTable( '#grid-customer' ) ) {
