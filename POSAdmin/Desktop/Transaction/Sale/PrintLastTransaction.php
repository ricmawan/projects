<?php
	...
	if (! $result=mysqli_query($dbh, $sql)) {
		...
		$FailedFlag = 1;
		logEvent(mysqli_error($dbh), '/Transaction/Sale/PrintLastTransaction.php', mysqli_real_escape_string($dbh, $_SESSION['UserLoginKasir']));
	...
	if($IsAttached == 'Y') {
		$sql = "CALL spSelLastSaleTransaction('".$_SESSION['UserLoginKasir']."')";
