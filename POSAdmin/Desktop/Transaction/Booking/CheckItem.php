<?php
	...
	if(isset($_POST['itemCode'])) {
		...
		$sql = "CALL spSelItemQtyDetails('".$ItemCode."', ".$BranchID.", '".$_SESSION['UserLoginKasir']."')";

		if (! $result = mysqli_query($dbh, $sql)) {
			$FailedFlag = 1;
			$ErrorMessage = "Terjadi kesalahan sistem.";
			logEvent(mysqli_error($dbh), '/Transaction/Booking/CheckItem.php', mysqli_real_escape_string($dbh, $_SESSION['UserLoginKasir']));
