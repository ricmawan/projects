		...
		<div id="FormCustomer" title="Tambah Item" >
			<form class="col-md-12" id="PostFormCustomer" method="POST" action="" >
				...
				<div class="row">
					...
					<div class="col-md-7">
						<textarea id="txtRemarksAdd" name="txtRemarksAdd" tabindex=75 class="form-control-custom" onfocus="this.select();" autocomplete=off placeholder="Keterangan"></textarea>
					</div>
				</div>
				<br />
			</form>
