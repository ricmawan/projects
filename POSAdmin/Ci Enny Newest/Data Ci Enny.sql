...
--
ALTER TABLE `master_item`
  MODIFY `ItemID` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70;
...
--
ALTER TABLE `master_supplier`
  MODIFY `SupplierID` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `transaction_purchasedetails`
  MODIFY `PurchaseDetailsID` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=120;
