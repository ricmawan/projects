...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 21, 2018 at 10:46 AM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `spInsBooking` (`pID` BIGINT, `pBookingNumber` VARCHAR(100), `pRetailFlag` BIT, `pCustomerID` BIGINT, `pTransactionDate` DATETIME, `pBookingDetailsID` BIGINT, `pBranchID` INT, `pItemID` BIGINT, `pItemDetailsID` BIGINT, `pQuantity` DOUBLE, `pBuyPrice` DOUBLE, `pBookingPrice` DOUBLE, `pDiscount` DOUBLE, `pUserID` BIGINT, `pCurrentUser` VARCHAR(255))  StoredProcedure:BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `spInsSale` (`pID` BIGINT, `pSaleNumber` VARCHAR(100), `pRetailFlag` BIT, `pCustomerID` BIGINT, `pTransactionDate` DATETIME, `pSaleDetailsID` BIGINT, `pBranchID` INT, `pItemID` BIGINT, `pItemDetailsID` BIGINT, `pQuantity` DOUBLE, `pBuyPrice` DOUBLE, `pSalePrice` DOUBLE, `pDiscount` DOUBLE, `pUserID` BIGINT, `pCurrentUser` VARCHAR(255))  StoredProcedure:BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `spSelStockDetailsReport` (`pItemCode` VARCHAR(100), `pBranchID` INT, `pFromDate` DATE, `pToDate` DATE, `pCurrentUser` VARCHAR(255))  StoredProcedure:BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `spUpdPurchase` (`pID` BIGINT, `pPurchaseNumber` VARCHAR(100), `pSupplierID` BIGINT, `pTransactionDate` DATETIME, `pCurrentUser` VARCHAR(255))  StoredProcedure:BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `spUpdSalePayment` (`pID` BIGINT, `pPayment` DOUBLE, `pPaymentTypeID` SMALLINT, `pCurrentUser` VARCHAR(255))  StoredProcedure:BEGIN
...
--
ALTER TABLE `master_eventlog`
  MODIFY `EventLogID` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `master_item`
--
ALTER TABLE `master_item`
  MODIFY `ItemID` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=89;
...
--
ALTER TABLE `transaction_purchase`
  MODIFY `PurchaseID` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;

--
-- AUTO_INCREMENT for table `transaction_purchasedetails`
--
ALTER TABLE `transaction_purchasedetails`
  MODIFY `PurchaseDetailsID` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=139;
