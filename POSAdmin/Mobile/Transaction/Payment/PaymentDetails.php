<?php
	if(ISSET($_POST['TransactionID'])) {
		...
		$sql = "CALL spSelPaymentDetails(".$TransactionID.", '".$TransactionType."', '".$_SESSION['UserLogin']."')";
		$FailedFlag = 0;

		if (! $result = mysqli_query($dbh, $sql)) {
			logEvent(mysqli_error($dbh), '/Transaction/Payment/PaymentDetails.php', mysqli_real_escape_string($dbh, $_SESSION['UserLogin']));
			$FailedFlag = 1;
			$json_data = array(
