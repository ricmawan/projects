	...
	*/
	...
	if(isset($_POST['SaleDetailsID'])) {
		...
		if (! $result = mysqli_query($dbh, $sql)) {
			logEvent(mysqli_error($dbh), '/Transaction/Sale/PrintShipment.php', mysqli_real_escape_string($dbh, $_SESSION['UserLoginMobile']));
		...
		if($SHIPMENT_PRINTER_INSTALLED == 'Y') {
			...
			$sql = "CALL spSelSaleDetailsPrint('(".implode(",", $SaleDetailsID).")', '".$_SESSION['UserLoginMobile']."')";
