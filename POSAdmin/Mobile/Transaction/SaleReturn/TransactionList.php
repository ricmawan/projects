<?php
	...
	$sql = "CALL spSelSale(\"$where\", '$order_by', $limit_s, $limit_l, '".$_SESSION['UserLoginMobile']."')";

	if (! $result = mysqli_query($dbh, $sql)) {
		logEvent(mysqli_error($dbh), '/Transaction/saleReturn/TransactionList.php', mysqli_real_escape_string($dbh, $_SESSION['UserLoginMobile']));
		return 0;
	}
