				...
				<div class="panel panel-default">
					<div class="panel-heading">
						...
						<span style="width:49%;display:inline-block;text-align:right;">
							...
							<?php
								if($DeleteFlag == true) echo '<button id="btnDelete" class="btn btn-danger" onclick="DeleteData(\'./Master/Category/Delete.php\');" ><i class="fa fa-close"></i> Hapus</button>';
			...
			<form class="col-md-12" id="PostForm" method="POST" action="" >
				<div class="row">
					<div class="col-md-5 labelColumn">
						Kode Kategori:
						<input id="hdnCategoryID" name="hdnCategoryID" type="hidden" value=0 />
						<input id="hdnIsEdit" name="hdnIsEdit" type="hidden" />
					</div>
					<div class="col-md-6">
						<input id="txtCategoryCode" name="txtCategoryCode" type="text" tabindex=5 class="form-control-custom" onfocus="this.select();" autocomplete=off placeholder="Kode" required />
					</div>
				</div>
				<br />
				<div class="row">
					...
					<div class="col-md-6">
						<input id="txtCategoryName" name="txtCategoryName" type="text" tabindex=6 class="form-control-custom"onfocus="this.select();" autocomplete=off placeholder="Kategori" required />
					</div>
				</div>
			</form>
		</div>
		<script>
			...
			$(document).ready(function() {
				...
				table = $("#grid-data").DataTable({
								...
								"processing": true,
								"serverSide": true,
								"ajax": "./Master/Category/DataSource.php",
								"language": {
				...
				table.on( 'key', function (e, datatable, key, cell, originalEvent) {
					...
					if(key == 32) { //space
						...
						setTimeout(function() { counterCategory = 0; } , 1000);
					}
				});
