<?php
	...
	if(ISSET($requestData['CustomerID']) && ISSET($requestData['FirstPass']) && $requestData['FirstPass'] == "0")
	{
		...
		$sql = "CALL spSelCustomerPurchaseReport(".$CustomerID.", '".$txtFromDate."', '".$txtToDate."', \"$where\", \"$where2\", '$order_by', $limit_s, $limit_l, '".$_SESSION['UserLogin']."')";
