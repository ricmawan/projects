		...
		<script>		
			...
			function ExportExcel() {
				...
				if(PassValidate == 0) {
					...
					$("#excelDownload").attr("src", "Report/NoStock/ExportExcel.php?BranchID=" + BranchID + "&BranchName=" + BranchName + "&CategoryID=" + CategoryID + "&CategoryName=" + CategoryName);
				}
			}
			...
			$(document).ready(function () {
				...
				$.fn.dataTable.ext.errMode = function(settings, techNote, message) { 
					...
					var counterError = 0;
					LogEvent(errorMessage, "/Transaction/Stock/index.php");
					Lobibox.alert("error",
					{
				...
				table = $("#grid-data").DataTable({
							...
							"columns": [
								...
								{ "width": "35%", className: "dt-head-center" },
							...
							"serverSide": true,
							"ajax": {
								"url": "./Report/NoStock/DataSource.php",
								"data": function ( d ) {
