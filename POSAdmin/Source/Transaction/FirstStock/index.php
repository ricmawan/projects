					...
					<table class="table table-striped table-hover" style="margin-bottom: 5px;" >
						<tbody>
							<tr>
								...
								<td style="width: 10%;" >
									<div class="has-float-label" >
										<input id="txtPrice2" name="txtPrice2" type="text" tabindex=15 class="form-control-custom text-right" style="width: 100%;" value="0" autocomplete=off onkeypress="isEnterKey(event, 'addFirstStockDetails');return isNumberKey(event, this.id, this.value);" onfocus="clearFormat(this.id, this.value);this.select();" onblur="convertRupiah(this.id, this.value);" onpaste="return false;" />
