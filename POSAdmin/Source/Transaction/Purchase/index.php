...
<html>
	...
	<body>
		...
		<div id="FormItem" title="Tambah Item" style="display: none;">
			<form class="col-md-12" id="PostFormItem" method="POST" action="" >
				<div class="row">
					...
					<div class="col-md-4">
						<input id="txtItemCodeAdd" name="txtItemCodeAdd" type="text" tabindex=16 class="form-control-custom" onfocus="this.select();" autocomplete=off placeholder="Kode Barang" required />
					</div>
				</div>
				<br />
				<div class="row">
				...
				<div class="row">
					...
					<div class="col-md-4">
						<div class="ui-widget" style="width: 100%;">
							<select id="ddlCategory" name="ddlCategory" tabindex=18 class="form-control-custom" placeholder="Pilih Kategori" >
				...
				<div class="row">
					...
					<div class="col-md-4">
						<input id="txtWeightAdd" name="txtWeightAdd" type="text" tabindex=25 class="form-control-custom text-right" value="0" autocomplete=off placeholder="Berat (KG)" onkeypress="return isNumberKey(event, this.id, this.value)" onfocus="clearFormat(this.id, this.value);this.select();" onblur="convertRupiah(this.id, this.value);" required />
					</div>
					<div class="col-md-2 labelColumn">
						Stok Minimal :
					</div>
					...
					<table class="table table-striped table-hover" style="margin-bottom: 5px;" >
						...
						<tbody>
							<tr>
								...
								<td style="width: 7%;" ><input id="txtQTY" name="txtQTY" type="number" tabindex=10 class="form-control-custom" style="width: 100%;" value=1 onchange="this.value = validateQTY(this.value);" onpaste="return false;" onfocus="this.select();" /></td>
