<?php
	...
	if(isset($_POST['hdnSaleReturnID'])) {
		...
		//68 col
		$Data .= "RETUR JUAL" . fnSpace(41);
		$Data .= "No : ". $SaleReturnNumber . $double0 . $bold0 ."\n";
		...
		$Data .= $CustomerName . $condensed1 ; //max 30
		$Data .= fnSpace(89 - strlen($CustomerName)) . "Tanggal : " .$TransactionDate. "\n"; //16 
