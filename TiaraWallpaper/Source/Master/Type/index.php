							...
							<table id="grid-data" class="table table-striped table-bordered table-hover" >
								<thead>				
									<tr>
										...
										<th data-column-id="SalePrice2" data-align="right">Harga Jual Sebelum PPN</th>
										<th data-column-id="SalePrice" data-align="right">Harga Jual Sesudah PPN</th>
