<?php
	if(isset($_GET['ID'])) {
		...
		if($TypeID != 0) {
			...
			$SalePrice2 = (100/110) * $row['SalePrice'];
		}
	}
?>
<html>
	...
	<body>
					...
					<div class="panel-body">
						<form class="col-md-12" id="PostForm" method="POST" action="" >
							...
							<div class="row">
								...
								<div class="col-md-3">
									<input id="txtSalePrice" name="txtSalePrice" type="text" class="form-control-custom" onclick="this.select();" onchange="calculatePrice();" onkeypress="return isNumberKey(event, this.id, this.value)" onfocus="clearFormat(this.id, this.value)" onblur="convertRupiah(this.id, this.value)" placeholder="Harga Jual Sesudah PPN" style="text-align:right;" <?php echo 'value="'.number_format($SalePrice,2,".",",").'"'; ?> />
								</div>
							</div>
							<br />
							<div class="row">
								...
								<div class="col-md-3">
									<input readonly id="txtSalePrice2" name="txtSalePrice2" type="text" class="form-control-custom" placeholder="Harga Jual Sebelum PPN" style="text-align:right;" <?php echo 'value="'.number_format($SalePrice2,2,".",",").'"'; ?> />
								</div>
							</div>
							<br />
		...
		<script>
			...
			function calculatePrice() {
				var SalePrice = $("#txtSalePrice").val().replace(/\,/g, "");
				var BuyPrice = (100/110) * SalePrice;
				$("#txtSalePrice2").val(returnRupiah(BuyPrice.toFixed(2).toString()));
			}
		</script>
	</body>
</html>
