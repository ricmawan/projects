...
!function($) {
    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            templates: {
                button: '<button type="button" style="width: 100%;display:block;text-align: left;" class="multiselect dropdown-toggle" data-toggle="dropdown"></button>',
                ...
                li: '<li><a href="javascript:void(0);"><label style="width: 100%; display:block;"></label></a></li>',
