		...
		<script>			
			function Preview() {
				...
				if(PassValidate == 0) {
					...
					$("#grid-data").bootgrid({
						...
						url: "Report/Salary/DataSource.php?DoctorID=" + DoctorID + "&ddlMonth=" + ddlMonth + "&ddlYear=" + ddlYear,
						selection: true,
						multiSelect: true,
						rowSelect: true,
						keepSelection: true
			...
			function ExportExcel() {
				...
				if(PassValidate == 0) {
					...
					$("#loading").show();
					$("#excelDownload").attr("src", "Report/Salary/ExportExcel.php?DoctorID=" + DoctorID + "&ddlMonth=" + ddlMonth + "&ddlYear=" + ddlYear);
					$("#loading").hide();
				}
			}
