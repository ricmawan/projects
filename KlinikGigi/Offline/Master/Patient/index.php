			...
			<div class="col-md-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<button class="btn btn-primary menu" link="./Master/Patient/Detail.php?ID=0"><i class="fa fa-plus "></i> Tambah</button>&nbsp;
						<?php if($DeleteFlag == true) echo '<button class="btn btn-danger" onclick="DeleteData(\'./Master/Patient/Delete.php\');" ><i class="fa fa-close"></i> Hapus</button>'; ?>
					</div>
				</div>
			</div>
		</div>
		<script>
			$(document).ready(function() {
				var grid = $("#grid-data").bootgrid({
							...
							url: "./Master/Patient/DataSource.php",
							selection: true,
							multiSelect: true,
							rowSelect: true,
							keepSelection: true,
							formatters: {
								...
								{
									return "<i style='cursor:pointer;' data-row-id=\"" + row.PatientID + "\" class=\"fa fa-edit\" data-link=\"./Master/Patient/Detail.php?ID=" + row.PatientID + "\" acronym title=\"Ubah Data\"></i>&nbsp;";
								}
							}
