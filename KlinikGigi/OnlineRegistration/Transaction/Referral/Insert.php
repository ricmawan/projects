<?php
	if(isset($_POST['hdnPatientName2'])) {
		$RequestPath = "$_SERVER[REQUEST_URI]";
		$file = basename($RequestPath);
		$RequestPath = str_replace($file, "", $RequestPath);
		include "../../DBConfig.php";
		$txtPatientName = mysql_real_escape_string($_POST['hdnPatientName2']);
		$txtPhone = mysql_real_escape_string($_POST['hdnPhone2']);
		$ddlTime = mysql_real_escape_string($_POST['hdnBusinessHour']);
		$txtEmail = mysql_real_escape_string($_POST['hdnEmail2']);
