<?php
	if(isset($_POST['OutgoingModelID'])) {
		...
		while ($row = mysql_fetch_array($result)) {
			...
			$OutgoingModelDetails .= "<td align='left' style='width: 150px;' >".$row['UserName']."</td>";
			$OutgoingModelDetails .= "<td align='left' style='width: 150px;' >".$row['PatientName']."</td>";
			$OutgoingModelDetails .= "<td align='left' style='width: 175px;' >".$row['ExaminationName']."</td>";
			$OutgoingModelDetails .= "<td align='left' style='width: 160px;' >".$row['Remarks']."</td>";
