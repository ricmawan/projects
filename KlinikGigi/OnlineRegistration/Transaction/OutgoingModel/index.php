			...
			<div class="col-md-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<button class="btn btn-danger" onclick="DeleteData('./Delete.php');" ><i class="fa fa-close"></i> Hapus</button>
					</div>
				</div>
			</div>
			...
			<div id="dialog-outgoing-model" title="Tambah Pengiriman" style="display: none;">
				...
				<div id="right-side" style="display: inline-block; width: calc(70% - 5px); height: 100%; float: left;">
					...
					<table class="table table-striped table-bordered table-hover" style="width:auto;padding-right:17px;" id="datainput">
						<thead style="background-color: black;color:white;height:25px;display:block;width:735px;">
							<td align="center" style="width:40px;">No</td>
							<td align="center" style="width: 150px;" >Dokter</td>
							<td align="center" style="width: 150px;" >Pasien</td>
							<td align="center" style="width: 175px;" >Tindakan</td>
							<td align="center" style="width: 160px;" >Keterangan</td>
