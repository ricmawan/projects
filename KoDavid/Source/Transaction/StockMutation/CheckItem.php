<?php
	...
	if(isset($_POST['itemCode'])) {
		...
		if (! $result = mysqli_query($dbh, $sql)) {
			...
			echo returnstate($ItemID, $ItemDetailsID, $ItemName, $UnitID, $AvailableUnit, $FailedFlag, $ErrorMessage);
			return 0;
		}
	...
	function  returnstate($ItemID, $ItemDetailsID, $ItemName, $UnitID, $AvailableUnit, $FailedFlag, $ErrorMessage) {
		$data = array(
			"ItemID" => $ItemID, 
			"ItemName" => $ItemName,
