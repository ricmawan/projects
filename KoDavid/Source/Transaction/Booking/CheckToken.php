<?php
	...
	if(isset($_POST['TokenCode'])) {
		...
		$sql = "CALL spSelTokenCode('".$TokenCode."', '".$_SESSION['UserLogin']."')";

		if (! $result = mysqli_query($dbh, $sql)) {
			$FailedFlag = 1;
			$ErrorMessage = "Terjadi kesalahan sistem.";
			logEvent(mysqli_error($dbh), '/Transaction/Booking/CheckToken.php', mysqli_real_escape_string($dbh, $_SESSION['UserLogin']));
