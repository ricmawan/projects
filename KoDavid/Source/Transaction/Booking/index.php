	...
	<body>
		...
		<script>
			...
			function addBookingDetailsRow() {
				...
				var subTotal = returnRupiah(((parseFloat(bookingPrice.replace(/\,/g, "")) - parseFloat(discount.replace(/\,/g, "")) ) * parseFloat(Qty)).toString());
				$.ajax({
			...
			$(document).ready(function() {
				...
				$(document).on("keydown", function (evt) {
					...
					else if(evt.keyCode == 123 && $("#customerList-dialog").css("display") == "none" && $("#itemList-dialog").css("display") == "none" && $("#finish-dialog").css("display") == "none" && $("#FormData").css("display") == "block"  && $(".lobibox").css("display") != "block") {
						evt.preventDefault();
						if(counterKey == 0) {
							itemList();
							counterKey = 1;
					...
					else if(evt.keyCode == 121 && $("#customerList-dialog").css("display") == "none" && $("#itemList-dialog").css("display") == "none"  && $("#finish-dialog").css("display") == "none" && $("#FormData").css("display") == "block"  && $(".lobibox").css("display") != "block") {
						evt.preventDefault();
						if(counterKey == 0) {
							finish();
							counterKey = 1;
