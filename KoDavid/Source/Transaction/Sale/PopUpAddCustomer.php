		...
		<div id="FormCustomer" title="Tambah Item" >
			<form class="col-md-12" id="PostFormCustomer" method="POST" action="" >
					...
					<div class="col-md-7">
						<select id="ddlCustomerPrice" name="ddlCustomerPrice" tabindex=75 class="form-control-custom" placeholder="Pilih Harga" >
							<?php
								...
								if (! $result = mysqli_query($dbh, $sql)) {
									logEvent(mysqli_error($dbh), '/Transaction/Sale/PopUpAddCustomer.php', mysqli_real_escape_string($dbh, $_SESSION['UserLogin']));
									return 0;
								}
				...
				<div class="row">
					...
					<div class="col-md-7">
						<textarea id="txtRemarksAdd" name="txtRemarksAdd" tabindex=76 class="form-control-custom" onkeydown="nextTabIndex(event, this);" onfocus="this.select();" autocomplete=off placeholder="Keterangan"></textarea>
					</div>
				</div>
				<br />
			</form>
