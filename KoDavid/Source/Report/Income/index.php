		...
		<script>		
			...
			function ExportExcel() {
				...
				if(PassValidate == 0) {
					...
					$("#excelDownload").attr("src", "Report/Income/ExportExcel.php?BranchID=" + BranchID + "&BranchName=" + BranchName + "&FromDate=" + txtFromDate + "&ToDate=" + txtToDate);
				}
			}
			...
			$(document).ready(function () {
				...
				$.fn.dataTable.ext.errMode = function(settings, techNote, message) { 
					...
					var counterError = 0;
					LogEvent(errorMessage, "/Transaction/Income/index.php");
					Lobibox.alert("error",
					{
				...
				table = $("#grid-data").DataTable({
							...
							"serverSide": true,
							"ajax": {
								"url": "./Report/Income/DataSource.php",
								"data": function ( d ) {
