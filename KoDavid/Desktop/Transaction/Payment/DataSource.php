<?php
	...
	$sql = "CALL spSelPayment(\"$where\", \"$where2\", '$order_by', $limit_s, $limit_l, '".$_SESSION['UserLoginKasir']."')";

	if (! $result = mysqli_query($dbh, $sql)) {
		logEvent(mysqli_error($dbh), '/Transaction/Payment/DataSource.php', mysqli_real_escape_string($dbh, $_SESSION['UserLoginKasir']));
		return 0;
	}
