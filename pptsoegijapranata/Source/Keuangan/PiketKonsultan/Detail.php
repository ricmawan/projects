		...
		if($cek==0) {
			...
			if($Id !=0) {
				...
				$sql = "SELECT
					...
					WHERE
						PK.KonsultanID = ".$Id."
						AND MONTH(PK.TanggalPiket) = MONTH(NOW())
						AND YEAR(PK.TanggalPiket) = YEAR(NOW())";
			...
			<div class="col-md-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<strong><?php if($Id == 0) echo "Ubah"; ?> Data Piket Konsultan</strong>  
					</div>
					<div class="panel-body">
						...
						<button class="btn btn-default" id="btnSave" onclick="SubmitForm('./Keuangan/PiketKonsultan/Insert.php');" ><i class="fa fa-save "></i> Simpan</button>&nbsp;&nbsp;							
					</div>
				</div>
			</div>
		</div>
