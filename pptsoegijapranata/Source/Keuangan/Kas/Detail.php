	...
	<body>
			...
			<div class="col-md-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<strong><?php if($Id == 0) echo "Tambah"; else echo "Ubah"; ?> Data Kas Keluar</strong>  
					</div>
					<div class="panel-body">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<input id="txtTanggal" name="txtTanggal" type="text" class="form-control DatePickerGlobal" placeholder="Tanggal" required <?php echo 'value="'.$Tanggal.'"'; ?> />
							</div>
						</div>
						<br />
						<div class="row">
										...
										<table class="table" id="datainput">
											...
											<tbody>
												<tr id='' align='center' style='display:none;'>
													...
													<td>
														<input type="text" id="txtJumlah" style="text-align:right;" name="txtJumlah" onkeypress="return isNumberKey(event, this.id, this.value)" onfocus="clearFormat(this.id, this.value)" onblur="convertRupiah(this.id, this.value)" onchange="calculate()" class="form-control txtJumlah" value="0.00" />
													</td>
												</tr>
		...
		<script>			
			...
			function SubmitValidate() {
				...
				SubmitForm("./Keuangan/Kas/Insert.php");
			}	
			function calculate() {
				var total = 0;
				$(".txtJumlah").each(function() {
					if($(this).val() == "") $(this).val("0");
					total += parseInt($(this).val().replace(/,00/g, "").replace(/\./g, ""));
				});
