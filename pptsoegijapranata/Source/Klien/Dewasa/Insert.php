<?php
	if(isset($_POST['hdnId'])) {
		...
		if($cek==0) {
			...
			$sql = "CALL spInsDewasa(".$Id.",'".$jenisKlien."','".$Nama."','".$JKelamin."', '".$TLahir."','".$TglLahir."','".$Orangtua."','".$Alamat."','".$Telepon."','".$StatusMarital."','".$Pekerjaan."','".$Keterangan."','".$hdnIsEdit."','".$_SESSION['Username']."')";
