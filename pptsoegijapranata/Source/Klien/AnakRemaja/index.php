	...
	if($cek==0) {
		...
		while ($row=mysql_fetch_row($result)) {
			...
			$Content .= "
						...
						";
			if($EditFlag == true) {
				$Content .='<td><i class="fa fa-edit menu" link="./Klien/AnakRemaja/Detail.php?id='.$row[0].'" acronym title="Ubah Data"></i>&nbsp;</td>';
			}
			$Content .= "</tr>";
		}
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<div class="table-responsive">
									...
									<button class="btn btn-primary menu" link="./Klien/AnakRemaja/Detail.php?id=0"><i class="fa fa-plus "></i> Tambah</button>&nbsp;<button class="btn btn-danger" onclick="DeleteData('./Klien/AnakRemaja/Delete.php');" ><i class="fa fa-close"></i> Hapus</button>
								</div>
							</div>
						</div>
				<?php
