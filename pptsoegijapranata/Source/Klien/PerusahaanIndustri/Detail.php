			...
			<div class="col-md-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<strong><?php if($Id == 0) echo "Tambah"; else echo "Ubah"; ?> Data Klien Perusahaan</strong>  
					</div>
					<div class="panel-body">
						<form class="col-md-6" id="PostForm" method="POST" action="" >
							...
							<br />
							<input type="button" class="btn btn-default" value="Simpan" onclick="SubmitForm('./Klien/PerusahaanIndustri/Insert.php');" />
						</form>
					</div>
				</div>
			</div>
