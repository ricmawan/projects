		...
		if($cek==0) {
			...
			for($i=0; $i<count($data); $i++) {
				try
				{
					...
					$username = $user[1];
					$iduser = $user[0];
					$sql = "DELETE FROM master_terapis WHERE TerapisID = $iduser";
			...
			if($messagesuccessdelete !="") $messagesuccess = "Terapis " .$messagesuccessdelete. " Berhasil Dihapus";
			else $messagesuccess = "";
			if($messagefaileddelete !="") $messagefailed = "Terapis " .$messagefaileddelete. " Gagal Dihapus";
			else $messagefailed = "";
