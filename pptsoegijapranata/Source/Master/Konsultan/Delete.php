		...
		if($cek==0) {
			...
			for($i=0; $i<count($data); $i++) {
				try
				{
					...
					$username = $user[1];
					$iduser = $user[0];
					$sql = "DELETE FROM master_konsultan WHERE KonsultanID = $iduser";
			...
			if($messagesuccessdelete !="") $messagesuccess = "Konsultan " .$messagesuccessdelete. " Berhasil Dihapus";
			else $messagesuccess = "";
			if($messagefaileddelete !="") $messagefailed = "Konsultan " .$messagefaileddelete. " Gagal Dihapus";
			else $messagefailed = "";
