						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<div class="table-responsive">
									...
									<button class="btn btn-primary menu" link="./Master/Layanan/Detail.php?id=0"><i class="fa fa-plus "></i> Tambah</button>&nbsp;<button class="btn btn-danger" onclick="DeleteData('./Master/Layanan/Delete.php');" ><i class="fa fa-close"></i> Hapus</button>
								</div>
							</div>
						</div>
				<?php
