			...
			<div class="col-md-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<strong><?php if($Id == 0) echo "Tambah"; else echo "Ubah"; ?> Data Supervisor</strong>  
					</div>
					<div class="panel-body">
						<form class="col-md-6" id="PostForm" method="POST" action="" >
							...
							<input type="button" class="btn btn-default" value="Simpan" onclick="SubmitForm('./Master/Supervisor/Insert.php');" />
						</form>
					</div>
				</div>
			</div>
