		...
		if($cek==0) {
			...
			for($i=0; $i<count($data); $i++) {
				try
				{
					...
					$username = $user[1];
					$iduser = $user[0];
					$sql = "DELETE FROM master_supervisor WHERE SupervisorID = $iduser";
			...
			if($messagesuccessdelete !="") $messagesuccess = "Supervisor " .$messagesuccessdelete. " Berhasil Dihapus";
			else $messagesuccess = "";
			if($messagefaileddelete !="") $messagefailed = "Supervisor " .$messagefaileddelete. " Gagal Dihapus";
			else $messagefailed = "";
