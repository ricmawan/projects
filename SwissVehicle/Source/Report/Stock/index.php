							...
							<table id="grid-data" class="table table-striped table-bordered table-hover" >
								<thead>				
									<tr>
										...
										<th data-column-id="PurchaseQty" data-align="right">Pembelian</th>
										<th data-column-id="UsageQty" data-align="right">Pemakaian</th>
		...
		<script>			
			function Preview() {
				...
				if(PassValidate == 0) {
					...
					$("#grid-data").bootgrid({
						...
						url: "Report/Stock/DataSource.php?ItemID=" + ItemID + "&txtFromDate=" + txtFromDate + "&txtToDate=" + txtToDate,
						selection: true,
						multiSelect: true,
						rowSelect: true,
						keepSelection: true
			...
			function PrintReport(PrintType) {
				...
				if(PassValidate == 0) {
					...
					form = $("#PostForm");
					form.attr("action", "./Report/Stock/Print.php?PrintType=" + PrintType);
