							...
							<table id="grid-data" class="table table-striped table-bordered table-hover" >
								<thead>				
									<tr>
										...
										<th data-column-id="CustomerName" >Pembeli</th>
		...
		<script>			
			function Preview() {
				...
				if(PassValidate == 0) {
					...
					$("#grid-data").bootgrid({
						...
						url: "Report/Sale/DataSource.php?ItemID=" + ItemID + "&txtFromDate=" + txtFromDate + "&txtToDate=" + txtToDate,
						selection: true,
						multiSelect: true,
						rowSelect: true,
						keepSelection: true
			...
			function PrintReport(PrintType) {
				...
				if(PassValidate == 0) {
					...
					form = $("#PostForm");
					form.attr("action", "./Report/Sale/Print.php?PrintType=" + PrintType + "&searchPhrase=" + searchPhrase + "&sort=" + sortDictionary);
