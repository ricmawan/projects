							...
							<table id="grid-data" class="table table-striped table-bordered table-hover" >
								<thead>				
									<tr>
										...
										<th data-column-id="PurchaseQty" data-align="right">Stok Masuk</th>
										<th data-column-id="UsageQty" data-align="right">Penjualan</th>
		...
		<script>			
			function Preview() {
				...
				if(PassValidate == 0) {
					...
					$("#grid-data").bootgrid({
						...
						url: "Report/SecondStock/DataSource.php?ItemID=" + ItemID + "&txtFromDate=" + txtFromDate + "&txtToDate=" + txtToDate,
						selection: true,
						multiSelect: true,
						rowSelect: true,
						keepSelection: true
			...
			function PrintReport(PrintType) {
				...
				if(PassValidate == 0) {
					...
					form = $("#PostForm");
					form.attr("action", "./Report/SecondStock/Print.php?PrintType=" + PrintType);
