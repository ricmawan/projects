					...
					<div class="panel-body">
						<div class="table-responsive">
							<table id="grid-data" class="table table-striped table-bordered table-hover" >
								<thead>				
									<tr>
										<th data-column-id="FuelID" data-visible="false" data-type="numeric" data-identifier="true">FuelID</th>
						...
						<button class="btn btn-primary menu" link="./Transaction/Fuel/Detail.php?ID=0"><i class="fa fa-plus "></i> Tambah</button>&nbsp;
						<?php if($DeleteFlag == true) echo '<button class="btn btn-danger" onclick="DeleteData(\'./Transaction/Fuel/Delete.php\');" ><i class="fa fa-close"></i> Hapus</button>'; ?>
					</div>
				</div>
			</div>
		</div>
		<script>
			$(document).ready(function() {
				var grid = $("#grid-data").bootgrid({
							...
							url: "./Transaction/Fuel/DataSource.php",
							selection: true,
							multiSelect: true,
							rowSelect: true,
							keepSelection: true,
							formatters: {
								...
								{
									return "<i style='cursor:pointer;' data-row-id=\"" + row.FuelID + "\" class=\"fa fa-edit\" data-link=\"./Transaction/Fuel/Detail.php?ID=" + row.FuelID + "\" acronym title=\"Ubah Data\"></i>&nbsp;";
								}
							}
